...
export const Footer = () => {
  return (
    <div>
      ...
      <footer className='p-4 bg-transparent sm:p-6 '>
        <div className='md:flex container mx-auto justify-between'>
          <div className='mb-6 md:mb-0'>
            <a href='' className='flex items-center'>
              <img
                src='/icons/vsheild-logo.png'
                className='mr-3 h-8'
                alt='VSheild Logo'
              />
            </a>
            <p className='text-sm text-gray-300 max-w-[300px] mt-3'>
              Here would come a paragraph that would describe the services
            </p>
          </div>
          {/* Margin left */}
          <div className='grid grid-cols-2 gap-12 sm:gap-8 lg:gap-14 sm:grid-cols-3'>
            <div>
