  ...
  return (
    <div className='relative col-span-full md:col-span-4 bg-[#23262F] shadow-md rounded-sm border border-gray-200'>
      ...
      <div className='px-5 pt-5 pb-6 border-b border-gray-200'>
        ...
        <button className='font-medium text-sm inline-flex items-center justify-center px-3 py-2 border border-gray-200 rounded leading-5 shadow-sm transition duration-150 ease-in-out focus:outline-none focus-visible:ring-2 hover:border-gray-300 text-gray-200 hover:bg-white hover:text-black w-full'>
          Order Now
        </button>
      </div>
